...
export const TimePickerModal: React.FC<TimePickerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-end sm:items-center justify-center p-0 sm:p-4 pt-16 sm:pt-20 bg-black/80 backdrop-blur-md animate-in fade-in duration-200 select-none">
      ...
      <div className="relative z-10 w-full max-w-sm bg-[#0e111d] border-t sm:border border-white/10 rounded-t-[28px] sm:rounded-3xl p-5 shadow-[0_-15px_40px_rgba(0,0,0,0.85)] sm:shadow-[0_25px_60px_rgba(0,0,0,0.9)] space-y-5 my-auto animate-in slide-in-from-bottom duration-300 ease-out">
