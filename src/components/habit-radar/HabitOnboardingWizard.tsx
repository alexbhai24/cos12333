...
const STARTER_PRESETS: StarterPreset[] = [
  ...
  { id: 'preset_walking', name: 'Walking', icon: 'footprints', color: '#4ade80', trackType: 'task' },
...
export const HabitOnboardingWizard: React.FC<HabitOnboardingWizardProps> = ({ onFinish }) => {
  ...
  return (
    <div className="min-h-[80vh] w-full max-w-xl mx-auto flex flex-col justify-between p-4 sm:p-6 pb-28 sm:pb-8 text-white font-sans select-none animate-in fade-in duration-300">
